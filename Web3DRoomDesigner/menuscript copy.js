...
const modelPaths = ['assets/models/BedDesignA.glb', 'assets/models/BedDesignB.glb', 'assets/models/BedDesignC.glb']; // Array to store all model paths
const currentModelIndex = 0; // index in the model array of the currently showing model
loader.load('assets/models/BedDesignA.glb', (result) => { modelArray[0] = result; displayModel(currentModelIndex)}); // load the first model and display it
loader.load('assets/models/BedDesignB.glb', (result) => { modelArray[1] = result}); // load all other models ready to show
loader.load('assets/models/BedDesignC.glb', (result) => { modelArray[2] = result});
